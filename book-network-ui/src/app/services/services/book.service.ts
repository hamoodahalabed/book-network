...
import { findAllBooksBorrowedFromMe } from '../fn/book/find-all-books-borrowed-from-me';
import { FindAllBooksBorrowedFromMe$Params } from '../fn/book/find-all-books-borrowed-from-me';
...
import { findAllMyBorrowedBooks } from '../fn/book/find-all-my-borrowed-books';
import { FindAllMyBorrowedBooks$Params } from '../fn/book/find-all-my-borrowed-books';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllBooksBorrowedFromMe()` */
  static readonly FindAllBooksBorrowedFromMePath = '/books/returned';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllBooksBorrowedFromMe()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBooksBorrowedFromMe$Response(params?: FindAllBooksBorrowedFromMe$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllBooksBorrowedFromMe(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllBooksBorrowedFromMe$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBooksBorrowedFromMe(params?: FindAllBooksBorrowedFromMe$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllBooksBorrowedFromMe$Response(params, context).pipe(
  ...
  /** Path part for operation `findAllMyBorrowedBooks()` */
  static readonly FindAllMyBorrowedBooksPath = '/books/borrowed';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllMyBorrowedBooks()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllMyBorrowedBooks$Response(params?: FindAllMyBorrowedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
    return findAllMyBorrowedBooks(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllMyBorrowedBooks$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllMyBorrowedBooks(params?: FindAllMyBorrowedBooks$Params, context?: HttpContext): Observable<PageResponseBorrowedBookResponse> {
    return this.findAllMyBorrowedBooks$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBorrowedBookResponse>): PageResponseBorrowedBookResponse => r.body)
    );
  }

  /** Path part for operation `findAllBorrowedBooks()` */
  static readonly FindAllBorrowedBooksPath = '/books/borrowed-book';
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooks$Response(params?: FindAllBorrowedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooks(params?: FindAllBorrowedBooks$Params, context?: HttpContext): Observable<number> {
